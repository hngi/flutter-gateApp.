...
class _AddVisitorPartState extends State<AddVisitorPart>
  ...
  Future shareInvite() async {
    ...
    await Share.file(
        'Estate Invite', 'qr.png', bytes.buffer.asUint8List(), 'image/png',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: ActionButton(
                ...
                onPressed: () async {
                  ...
                  final date = DateFormat('yyyy-MM-dd').format(DateFormat()
                      .add_yMd()
                  ...
                  if (_fullNameController.text == "") {
                    ...
                    dynamic response = await NewVisitorService.addVisitor(
                        ...
                        status: '8',
                        estateId:
                            '7', //image: image==null?null:image.path.toString(),
                        authToken: await authToken(context),
                        image: image ?? null);
                    print(response);
            ...
            VisitorsBox(
              visitorsName: 'Michael Raggae',
              visitorsNumber: '09087675434',
              visitorsCategory: 'Family',
            ),
            VisitorsBox(
              visitorsName: 'Michael Raggae',
              visitorsNumber: '09087675434',
