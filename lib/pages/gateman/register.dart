      ...
      body: ListView(
        children: <Widget>[
          Padding(
                ...
                child: Text('Register',
                    style: TextStyle(fontSize: 42.0, color: GateManColors.primaryColor))),
          Padding(
                padding: EdgeInsets.only(top: 10.0, left: 20.0, right: 20.0),
                child: Text('Welcome to a peaceful and safe way to manage your visitors',
          ...
          child: Padding(
            ...
            Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text('Full name', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15.7, color: Colors.black54),),
                Padding(
                  ...
                  child: TextFormField(
                      ...
                      validator: (value){return value.isEmpty ? 'Full name is required' : null;}
                      ),
                ),
              ],
            ),
            ActionButton(buttonText: 'Join', 
            onPressed: (){
              
              if (_formKey.currentState.validate()){
                 Navigator.of(context).push(MaterialPageRoute(builder: (context) => new GatemanWelcome(fullname: _fnameController.text,)));
              }
