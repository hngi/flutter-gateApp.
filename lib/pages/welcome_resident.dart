...
class WelcomeResident extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ResidentUserProvider residentUserProvider = Provider.of<ResidentUserProvider>(context, listen:false);
      ...
      ListView(
        ...
        children: <Widget>[
          ...
          Align(
            ...
            child: Text('Hi, '+residentUserProvider.residentUserModel.residentFullName.toString(),
                style: TextStyle(
                    fontSize: 43.0,
      ...
      ListView(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text('Hi, '+residentUserProvider.residentUserModel.residentFullName,
                style: TextStyle(
