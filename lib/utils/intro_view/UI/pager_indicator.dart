...
class PagerIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      bubbles.add(PageBubble(
        viewModel: PageBubbleViewModel(
         ...
         // iconColor: Colors.red,
          isHollow: false,//isHollow,
          activePercent: percentActive,
          bubbleBackgroundColor: Color(0xFFFFC700), //page.bubbleBackgroundColor,
        //  bubbleInner: 
          //  Icon(Icons.check_circle,
          // color:Color(0xFFE21800),
          // size: 10),
        ),
      ));
    }
    ...
    final baseTranslation =
        ((viewModel.pages.length * BUBBLE_WIDTH) / 3) - (BUBBLE_WIDTH / 3);
